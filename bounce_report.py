...
def main():
    ...
    push_domain_stats_to_supabase(
        domain_report, START_DATE, END_DATE, numerator_col_name="bounced"
    )
    push_mailbox_stats_to_supabase(
        mailbox_report, START_DATE, END_DATE, numerator_col_name="bounced", mailbox_limits=mailbox_limits
    )
